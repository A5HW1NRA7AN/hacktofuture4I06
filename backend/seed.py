...
from tickets.models import ExternalIdentity, UnifiedTicket
...
UserProfile.objects.get_or_create(
    user=user, defaults={"organization": org, "is_onboarded": True}
)
...
jira_int, _ = Integration.objects.get_or_create(
    organization=org,
    provider="jira",
    defaults={"name": "Jira Production", "is_active": True},
)

slack_int, _ = Integration.objects.get_or_create(
    organization=org,
    provider="slack",
    defaults={"name": "Slack Engineering", "is_active": True},
)
...
ext_identity, _ = ExternalIdentity.objects.get_or_create(
    ...
    defaults={"display_name": "Jane Developer", "email": "jane@acme.com", "user": user},
)
...
ticket_data = [
    {
        "ext_id": "ENG-101",
        "title": "Fix database serialization rounding bug natively",
        "status": "open",
        "type": "bug",
        "priority": "high",
    },
    {
        "ext_id": "ENG-102",
        "title": "Implement WebSockets for Chat",
        "status": "in_progress",
        "type": "feature",
        "priority": "medium",
    },
    {
        "ext_id": "ENG-103",
        "title": "Refactor React hooks component state",
        "status": "resolved",
        "type": "task",
        "priority": "low",
    },
    {
        "ext_id": "ENG-104",
        "title": "Investigate memory leak in Celery workers",
        "status": "blocked",
        "type": "bug",
        "priority": "critical",
    },
    {
        "ext_id": "ENG-105",
        "title": "Upgrade PostgreSQL to v14",
        "status": "open",
        "type": "task",
        "priority": "medium",
    },
    {
        "ext_id": "ENG-106",
        "title": "Redesign Operator Dashboard UI",
        "status": "in_progress",
        "type": "story",
        "priority": "medium",
    },
    {
        "ext_id": "ENG-107",
        "title": "Document LangGraph workflow nodes",
        "status": "resolved",
        "type": "task",
        "priority": "low",
    },
